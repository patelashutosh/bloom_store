...
export const metadata: Metadata = {
  title: 'Sign In | Bloom AI',
  description: 'Sign in to your Bloom AI account',
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription className="text-gray-600">
              Sign in to your Bloom AI account to continue shopping
            </CardDescription>
          </CardHeader>
        ...
        {/* Optional: Show callback URL info for debugging */}
        {params.callbackUrl && (
          <div className="text-center">
